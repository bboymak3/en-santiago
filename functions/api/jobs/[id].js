...
<div class="ej-lb" id="ejLb"><button class="ej-lb-x" onclick="closeEjLb()">&times;</button><button class="ej-lb-n ej-lb-p" onclick="event.stopPropagation();navEjLb(-1)"><i class="fas fa-chevron-left"></i></button><button class="ej-lb-n ej-lb-nx" onclick="event.stopPropagation();navEjLb(1)"><i class="fas fa-chevron-right"></i></button></div>
